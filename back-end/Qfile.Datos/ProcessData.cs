...
namespace Qfile.Datos
{
    public class ProcessData : IProcessData
    {
        ...
        public ProcessData(IConnectionProvider connectionProvider)
        {
        ...
        public async Task<List<ProcesoModelo>> GetAllAsync(int idEntity)
        {
            ...
            using (var connection = await connectionProvider.OpenAsync())
            {
                ...
                AND pr.id_entidad = @idEntity
                ORDER BY pr.id_proceso";

                var result = await connection.QueryAsync<ProcesoModelo>(sqlQuery, new { idEntity });
        ...
        public async Task<int> EliminarProcesoAsync(int idEntidad, int idProceso)
        {
            ...
            using (var connection = await connectionProvider.OpenAsync())
            {
                ...
                var response = await connection.ExecuteAsync(insertarProcesoSQL, new { idEntidad, idProceso });
