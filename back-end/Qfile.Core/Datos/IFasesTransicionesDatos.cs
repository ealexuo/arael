...
{
    public interface IFasesTransicionesDatos
    {
        Task<List<FaseModelo>> ObtenerFasesAsync(int idEntidad, int idProceso);
        Task<FaseModelo> ObtenerFaseAsync(int idEntidad, int idProceso, int idFase);
        ...
        Task<bool> ExisteFaseInicial(int idEntidad, int idProceso);
        ...
        Task<bool> ExistenExpedientesAsigandosALaFase(int idEntidad, int idProceso, int idFase);
